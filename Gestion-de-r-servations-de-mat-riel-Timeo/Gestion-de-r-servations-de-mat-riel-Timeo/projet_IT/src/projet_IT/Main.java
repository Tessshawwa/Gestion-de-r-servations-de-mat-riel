...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            // 
            Date dateDebut = sdf.parse("2026-02-03 10:00");		//Convertir le format de date avec celui que l'on a fait
            String duree = "2 heures"; // minutes
            String type = "Emprunt";
            Date DerMAJ = sdf.parse("2026-02-01 12:00");
            Reservation reservation1 = new Reservation(type, dateDebut, duree, alice, pc1,DerMAJ);
